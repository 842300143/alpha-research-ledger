...
| `P0_7E_ALPHA_RESEARCH_V2` | 3 Formula candidates + 4 ElasticNet family ablations | `NOT_STARTED` | `NOT_STARTED` | Ledger design: `tasks/planned/P0_7E_ALPHA_RESEARCH_V2.md` | Bound to P0-7D result `d06b21fe5bcea2b394be0d6b7a09006a2518aaf37d04933631b4a5b49fbcb360`; no new dataset | ADR-0011; ADR-0012; ADR-0013 | `DESIGN_READY` / `NOT_YET_EXECUTED` |
