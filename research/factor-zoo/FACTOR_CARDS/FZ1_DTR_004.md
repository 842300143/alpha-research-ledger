# FZ1_DTR_004 — Negative maximum drawdown 60

- Family: `DOWNSIDE_TAIL_RISK`
- Concept: `RECENT_DRAWDOWN_SEVERITY`
- Parameterization group: `FZ1_DTR_004` / `SINGLE`
...
Securities with shallower recent path drawdowns may carry lower distress or crash exposure.
