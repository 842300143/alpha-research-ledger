# FZ1_EFF_004 — Variance ratio 20/5

- Family: `PRICE_EFFICIENCY_TREND_NOISE`
- Concept: `RETURN_VARIANCE_RATIO`
- Parameterization group: `FZ1_EFF_004` / `SINGLE`
...
`var(r5 over 20)/(5*var(r1 over 20)+1e-12)`

Lookback/input horizon: 25 sessions.
...
Variance aggregation above or below a random-walk benchmark may reveal continuation or mean reversion.
