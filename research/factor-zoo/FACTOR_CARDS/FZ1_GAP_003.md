# FZ1_GAP_003 — Gap reversal after large gap 5

- Family: `GAP_OPEN_CLOSE`
- Concept: `GAP_SHOCK_REVERSAL`
- Parameterization group: `FZ1_GAP_003` / `SINGLE`
...
`-gap[t] * abs_zscore_time(gap[t], prior20)`
...
Unusually large overnight shocks may overreact and reverse more strongly than ordinary gaps.
