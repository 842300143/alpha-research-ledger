# FZ1_LIQ_004 — Negative zero-activity frequency 20

- Family: `LIQUIDITY`
- Concept: `TRADING_CONTINUITY`
- Parameterization group: `FZ1_LIQ_004` / `SINGLE`
- Abstraction: `ATOMIC`
...
`-mean(1[volume<=0 or amount<=0] over 20)`
...
- `rolling activity-state indicators`
...
Continuous activity may indicate better implementability and lower latent trading friction.
