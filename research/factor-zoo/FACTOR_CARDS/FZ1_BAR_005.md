# FZ1_BAR_005 — Lower-shadow support share 20

- Family: `INTRADAY_DAILY_BAR`
- Concept: `LOWER_SUPPORT`
- Parameterization group: `FZ1_BAR_005` / `SINGLE`
- Abstraction: `ATOMIC`
...
`mean((min(adj_open,adj_close)-adj_low)/(adj_high-adj_low) over 20)`
...
Frequent recovery from intraday lows may indicate support and resilient demand.
