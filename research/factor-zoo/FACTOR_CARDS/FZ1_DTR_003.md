# FZ1_DTR_003 — Negative semivariance share 60

- Family: `DOWNSIDE_TAIL_RISK`
- Concept: `DOWNSIDE_SEMIVARIANCE_SHARE`
- Parameterization group: `FZ1_DTR_003` / `SINGLE`
...
`-sum(min(r1,0)^2)/sum(r1^2) over 60`
...
A larger fraction of variance from losses may indicate asymmetric risk not visible in total volatility.
