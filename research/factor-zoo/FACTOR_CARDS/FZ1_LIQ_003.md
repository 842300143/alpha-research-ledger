# FZ1_LIQ_003 — Log average amount 20

- Family: `LIQUIDITY`
- Concept: `TRADING_AMOUNT_LEVEL`
- Parameterization group: `FZ1_LIQ_003` / `SINGLE`
- Abstraction: `ATOMIC`
...
Higher traded amount may proxy ease of execution and persistent investor attention.
