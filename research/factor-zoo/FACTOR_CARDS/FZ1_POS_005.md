# FZ1_POS_005 — Price versus rolling VWAP proxy 20

- Family: `PRICE_RANGE_POSITION`
- Concept: `PRICE_TO_VWAP_PROXY`
- Parameterization group: `FZ1_POS_005` / `SINGLE`
...
`adj_close[t]/(sum(amount,20)/sum(volume,20) adjusted to validated units)-1`
...
Price above the volume-weighted transaction proxy may indicate profitable holder positioning or trend.
...
- `CURRENT_CAPTURE_NON_PIT_UNIVERSE`
- `VWAP_PROXY_REQUIRES_UNIT_VALIDATION`
