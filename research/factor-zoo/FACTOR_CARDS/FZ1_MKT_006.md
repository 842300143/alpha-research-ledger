# FZ1_MKT_006 — Negative downside beta 120

- Family: `MARKET_BETA_RESIDUAL`
- Concept: `LOW_DOWNSIDE_BETA`
- Parameterization group: `FZ1_MKT_006` / `SINGLE`
...
`-cov(r1,market_r1 | market_r1<0,120)/(var(market_r1 | market_r1<0)+1e-12)`
...
Lower sensitivity in negative market sessions may identify defensive asymmetry not captured by full beta.
