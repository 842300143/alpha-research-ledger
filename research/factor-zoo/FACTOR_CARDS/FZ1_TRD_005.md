# FZ1_TRD_005 — Trend t-statistic 60

- Family: `TREND`
- Concept: `REGRESSION_TREND_SIGNIFICANCE`
- Parameterization group: `FZ1_TRD_005` / `SINGLE`
...
`OLS_slope_t_stat(log(adj_close[t-59:t]) ~ 0..59)`
...
A statistically coherent trend may be more repeatable than a noisy slope of the same size.
