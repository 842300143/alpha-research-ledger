# FZ1_DTR_002 — Negative downside deviation 60

- Family: `DOWNSIDE_TAIL_RISK`
- Concept: `LOW_DOWNSIDE_VOLATILITY`
- Parameterization group: `PG_DTR_DOWNSIDE_VOL` / `MEDIUM`
- Abstraction: `ATOMIC`
...
`-std(min(r1,0) over t-59:t) * sqrt(252)`
...
- `STANDARD_DOWNSIDE_RISK`
- `P0_7C_DOWNSIDE_VOL_LINEAGE`
