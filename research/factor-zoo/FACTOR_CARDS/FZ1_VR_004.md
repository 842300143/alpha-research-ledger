# FZ1_VR_004 — Return-absolute-return correlation 60

- Family: `VOLATILITY_RETURN_RELATION`
- Concept: `RETURN_VOLATILITY_FEEDBACK`
- Parameterization group: `FZ1_VR_004` / `SINGLE`
...
The sign of return-volatility feedback distinguishes upside excitement from downside risk concentration.
