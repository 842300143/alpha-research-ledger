# FZ1_BRK_004 — Prior-high breakout indicator 60

- Family: `HIGH_LOW_BREAKOUT`
- Concept: `BREAKOUT_EVENT`
- Parameterization group: `FZ1_BRK_004` / `SINGLE`
- Abstraction: `ATOMIC`
...
`1[adj_close[t] > max(adj_high[t-60:t-1])]`
...
A clean break above a medium-term high may reveal new information or demand.
