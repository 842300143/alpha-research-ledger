# FZ1_TRD_002 — Price above SMA 60

- Family: `TREND`
- Concept: `PRICE_TO_MOVING_AVERAGE`
- Parameterization group: `PG_TREND_PRICE_SMA` / `MEDIUM`
- Abstraction: `ATOMIC`
...
`adj_close[t] / mean(adj_close[t-59:t]) - 1`
...
A price above its trailing equilibrium may indicate a persistent trend.
