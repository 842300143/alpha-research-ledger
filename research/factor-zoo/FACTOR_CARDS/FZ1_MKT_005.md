# FZ1_MKT_005 — Negative idiosyncratic volatility 60 residual

- Family: `MARKET_BETA_RESIDUAL`
- Concept: `LOW_RESIDUAL_RISK`
- Parameterization group: `FZ1_MKT_005` / `SINGLE`
...
`-std(OLS_residual(r1~market_r1) over 60)`
...
Low stock-specific risk may be distinct from raw low volatility.
