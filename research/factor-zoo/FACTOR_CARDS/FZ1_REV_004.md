# FZ1_REV_004 — Largest one-day gain reversal 20

- Family: `REVERSAL`
- Concept: `EXTREME_GAIN_REVERSAL`
- Parameterization group: `FZ1_REV_004` / `SINGLE`
...
A single extreme positive move may contain transitory attention or price pressure that reverses.
