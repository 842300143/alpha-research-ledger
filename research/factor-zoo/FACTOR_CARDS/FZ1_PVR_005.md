# FZ1_PVR_005 — Price-volume divergence 20

- Family: `PRICE_VOLUME_RELATION`
- Concept: `PRICE_VOLUME_DIVERGENCE`
- Parameterization group: `FZ1_PVR_005` / `SINGLE`
...
`rank_cs(ret20) - rank_cs(volume_5_to_20_change)`
...
A price move unsupported by activity may be fragile and more likely to reverse.
