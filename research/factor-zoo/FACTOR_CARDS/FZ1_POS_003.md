# FZ1_POS_003 — Percentile price position 252

- Family: `PRICE_RANGE_POSITION`
- Concept: `LONG_HORIZON_PRICE_POSITION`
- Parameterization group: `FZ1_POS_003` / `SINGLE`
- Abstraction: `ATOMIC`
...
`percentile_rank(adj_close[t] within adj_close[t-251:t])`

Lookback/input horizon: 252 sessions.
...
Long-horizon location may separate persistent leaders from distressed laggards.
