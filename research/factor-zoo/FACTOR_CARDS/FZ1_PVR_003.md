# FZ1_PVR_003 — On-balance-volume slope 20

- Family: `PRICE_VOLUME_RELATION`
- Concept: `ON_BALANCE_VOLUME_TREND`
- Parameterization group: `FZ1_PVR_003` / `SINGLE`
...
`OLS_slope(cumsum(sign(r1)*volume) over 20)`
...
Volume signed by price direction may identify accumulation not visible in return alone.
