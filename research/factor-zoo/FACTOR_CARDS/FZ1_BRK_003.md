# FZ1_BRK_003 — Distance above prior low 20

- Family: `HIGH_LOW_BREAKOUT`
- Concept: `DISTANCE_FROM_PRIOR_LOW`
- Parameterization group: `FZ1_BRK_003` / `SINGLE`
- Abstraction: `ATOMIC`
...
`adj_close[t]/min(adj_low[t-20:t-1])-1`
...
Distance from a recent low distinguishes recovery strength from proximity to breakdown.
