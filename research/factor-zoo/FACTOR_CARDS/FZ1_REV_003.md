# FZ1_REV_003 — Medium reversal excluding latest 5

- Family: `REVERSAL`
- Concept: `MEDIUM_REVERSAL_EX_RECENT`
- Parameterization group: `FZ1_REV_003` / `SINGLE`
- Abstraction: `ATOMIC`
...
`-(adj_close[t-5] / adj_close[t-20] - 1)`

Lookback/input horizon: 20 sessions; latest 5 excluded.
...
Inventory or behavioral correction in the preceding medium window may differ from very-short microstructure reversal.
