# FZ1_BAR_001 — Close location value

- Family: `INTRADAY_DAILY_BAR`
- Concept: `CLOSE_LOCATION`
- Parameterization group: `FZ1_BAR_001` / `SINGLE`
- Abstraction: `ATOMIC`
...
`(2*adj_close-adj_high-adj_low)/(adj_high-adj_low)`

Lookback/input horizon: 1 session.
...
Closing near the daily high may indicate persistent demand within the session.
