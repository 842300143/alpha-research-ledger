# FZ1_VOLM_001 — Log average raw volume 20

- Family: `RAW_RELATIVE_VOLUME`
- Concept: `RAW_VOLUME_LEVEL`
- Parameterization group: `FZ1_VOLM_001` / `SINGLE`
- Abstraction: `ATOMIC`
...
Persistent volume level may proxy attention and tradability, subject to security scale and split limitations.
