# FZ1_RNG_006 — Range expansion 5 versus 20

- Family: `RANGE_ATR_COMPRESSION`
- Concept: `RANGE_EXPANSION`
- Parameterization group: `FZ1_RNG_006` / `SINGLE`
- Abstraction: `ATOMIC`
...
`mean((adj_high-adj_low)/adj_close over 5) / mean(... over 20) - 1`
...
Recent range expansion may identify active price discovery and short-lived continuation.
