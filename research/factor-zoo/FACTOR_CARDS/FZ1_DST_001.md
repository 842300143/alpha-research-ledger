# FZ1_DST_001 — Negative return skewness 60

- Family: `DISTRIBUTION_SHAPE`
- Concept: `RETURN_SKEWNESS`
- Parameterization group: `FZ1_DST_001` / `SINGLE`
...
Return asymmetry may proxy lottery demand or crash exposure; lower positive skew is expected to be less overpriced.
