# FZ1_LIQ_005 — Negative amount coefficient of variation 20

- Family: `LIQUIDITY`
- Concept: `LIQUIDITY_STABILITY`
- Parameterization group: `FZ1_LIQ_005` / `SINGLE`
...
- `rolling amount mean and standard deviation`
...
Stable trading amount may signal persistent liquidity rather than event-driven bursts.
