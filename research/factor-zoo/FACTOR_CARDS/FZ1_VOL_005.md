# FZ1_VOL_005 — Negative idiosyncratic volatility 60

- Family: `VOLATILITY`
- Concept: `LOW_IDIOSYNCRATIC_VOLATILITY`
- Parameterization group: `FZ1_VOL_005` / `SINGLE`
...
`-std(residual_OLS(r1 ~ equal_weight_market_r1) over 60)`
...
Lower market-adjusted residual risk may contain information distinct from total volatility.
