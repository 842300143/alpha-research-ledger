# FZ1_TRD_004 — Log-price regression slope 60

- Family: `TREND`
- Concept: `REGRESSION_TREND_SLOPE`
- Parameterization group: `FZ1_TRD_004` / `SINGLE`
...
`OLS_slope(log(adj_close[t-59:t]) ~ 0..59) * 252`
...
A distributed regression slope may measure trend with less endpoint sensitivity.
