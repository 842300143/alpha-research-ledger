# FZ1_VOL_006 — Negative intraday range volatility 20

- Family: `VOLATILITY`
- Concept: `LOW_INTRADAY_RANGE_VOLATILITY`
- Parameterization group: `FZ1_VOL_006` / `SINGLE`
- Abstraction: `ATOMIC`
...
`-mean(log(adj_high/adj_low)^2 over 20)`
...
Daily high-low range supplies a close-independent proxy for realized variability.
