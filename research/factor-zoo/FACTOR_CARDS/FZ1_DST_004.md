# FZ1_DST_004 — Negative median absolute return deviation 20

- Family: `DISTRIBUTION_SHAPE`
- Concept: `ROBUST_RETURN_DISPERSION`
- Parameterization group: `FZ1_DST_004` / `SINGLE`
...
`-median(abs(r1-median(r1)) over 20)`
...
Low robust dispersion may capture stable risk while reducing sensitivity to single jumps.
