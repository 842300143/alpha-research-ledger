# FZ1_DST_003 — Up-minus-down day balance 20

- Family: `DISTRIBUTION_SHAPE`
- Concept: `RETURN_SIGN_BALANCE`
- Parameterization group: `FZ1_DST_003` / `SINGLE`
- Abstraction: `ATOMIC`
...
A broad excess of positive days may indicate persistent demand beyond total return magnitude.
