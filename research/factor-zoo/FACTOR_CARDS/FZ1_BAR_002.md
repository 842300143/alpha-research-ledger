# FZ1_BAR_002 — Intraday open-close return

- Family: `INTRADAY_DAILY_BAR`
- Concept: `INTRADAY_RETURN`
- Parameterization group: `FZ1_BAR_002` / `SINGLE`
- Abstraction: `ATOMIC`
...
Within-session price movement may carry information distinct from overnight gaps.
