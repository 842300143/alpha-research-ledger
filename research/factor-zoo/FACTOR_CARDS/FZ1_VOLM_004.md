# FZ1_VOLM_004 — Negative volume variability 20

- Family: `RAW_RELATIVE_VOLUME`
- Concept: `VOLUME_STABILITY`
- Parameterization group: `FZ1_VOLM_004` / `SINGLE`
...
`-std(volume,20)/(mean(volume,20)+1e-12)`
...
- `rolling volume mean and standard deviation`
...
Stable activity may be more implementable and less event-driven than volatile volume.
