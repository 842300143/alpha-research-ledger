# FZ1_TRD_006 — Positive-return day share 20

- Family: `TREND`
- Concept: `TREND_PERSISTENCE`
- Parameterization group: `FZ1_TRD_006` / `SINGLE`
- Abstraction: `ATOMIC`
...
Broad day-by-day participation may distinguish persistent trends from single jumps.
