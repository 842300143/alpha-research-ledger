# FZ1_MKT_003 — Residual momentum 60

- Family: `MARKET_BETA_RESIDUAL`
- Concept: `MARKET_ADJUSTED_MOMENTUM`
- Parameterization group: `FZ1_MKT_003` / `SINGLE`
...
`sum(OLS_residual(r1~market_r1) over 60)`
...
Market-adjusted persistent return may be more stock-specific than raw momentum.
