# FZ1_PVR_004 — Volume-confirmed momentum 20

- Family: `PRICE_VOLUME_RELATION`
- Concept: `VOLUME_CONFIRMED_MOMENTUM`
- Parameterization group: `FZ1_PVR_004` / `SINGLE`
...
`rank_cs(ret20) * rank_cs(log((volume[t]+1)/(mean(volume,20)+1)))`
...
Momentum accompanied by abnormal activity may reflect stronger information diffusion than price movement alone.
