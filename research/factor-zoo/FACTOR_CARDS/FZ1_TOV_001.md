# FZ1_TOV_001 — Negative mean turnover 20

- Family: `TURNOVER_DYNAMICS`
- Concept: `LOW_TURNOVER_LEVEL`
- Parameterization group: `FZ1_TOV_001` / `SINGLE`
- Abstraction: `ATOMIC`
...
Low turnover may proxy neglected securities or a liquidity/attention premium.
