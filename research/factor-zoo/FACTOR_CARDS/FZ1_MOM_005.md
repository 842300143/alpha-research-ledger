# FZ1_MOM_005 — Return acceleration 20 versus 60

- Family: `MOMENTUM`
- Concept: `MOMENTUM_ACCELERATION`
- Parameterization group: `FZ1_MOM_005` / `SINGLE`
...
A recent increase in the per-session return trend may identify strengthening information diffusion.
