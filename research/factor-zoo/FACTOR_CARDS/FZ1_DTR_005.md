# FZ1_DTR_005 — Expected shortfall quality proxy 120

- Family: `DOWNSIDE_TAIL_RISK`
- Concept: `TAIL_LOSS_SEVERITY`
- Parameterization group: `FZ1_DTR_005` / `SINGLE`
...
`mean(worst ceil(0.05*120) r1 values over 120)`

Lookback/input horizon: 120 sessions.
...
Less severe realized left-tail losses produce a higher score and may identify a distinct defensive dimension.
