# FZ1_BRK_005 — New-high frequency 60

- Family: `HIGH_LOW_BREAKOUT`
- Concept: `BREAKOUT_PERSISTENCE`
- Parameterization group: `FZ1_BRK_005` / `SINGLE`
...
`mean(1[adj_close[s]>=rolling_prior_high20[s]] over 60)`

Lookback/input horizon: 80 sessions.
...
Repeated new highs may identify persistent leadership rather than a single breakout.
