# FZ1_VR_003 — Upside-minus-downside volatility balance 60

- Family: `VOLATILITY_RETURN_RELATION`
- Concept: `VOLATILITY_ASYMMETRY`
- Parameterization group: `FZ1_VR_003` / `SINGLE`
...
`std(max(r1,0),60)-std(min(r1,0),60)`
...
More upside than downside variation may indicate favorable asymmetric information.
