# FZ1_VOL_004 — Negative volatility-of-volatility 60

- Family: `VOLATILITY`
- Concept: `VOLATILITY_STABILITY`
- Parameterization group: `FZ1_VOL_004` / `SINGLE`
...
`-std(rolling_std_10(r1)[t-59:t])`

Lookback/input horizon: 69 sessions.
...
Stable volatility may be less exposed to latent event risk than an equally low but unstable volatility level.
