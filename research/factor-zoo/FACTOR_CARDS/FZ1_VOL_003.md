# FZ1_VOL_003 — Negative EWMA volatility 20

- Family: `VOLATILITY`
- Concept: `LOW_EWMA_VOLATILITY`
- Parameterization group: `FZ1_VOL_003` / `SINGLE`
...
`-sqrt(252 * EWMA_lambda0.94(r1^2,20))`

Lookback/input horizon: 20 sessions; lambda 0.94.
...
Recency-weighted low volatility may capture current risk state faster than an equal-weight estimator.
