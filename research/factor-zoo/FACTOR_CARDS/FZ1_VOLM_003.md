# FZ1_VOLM_003 — Volume trend 5/prior60

- Family: `RAW_RELATIVE_VOLUME`
- Concept: `VOLUME_TREND`
- Parameterization group: `FZ1_VOLM_003` / `SINGLE`
- Abstraction: `ATOMIC`
...
`log((mean(volume,t-4:t)+1)/(mean(volume,t-64:t-5)+1))`
...
A sustained change in raw activity may indicate changing information arrival.
