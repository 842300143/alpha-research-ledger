# FZ1_DST_005 — Negative-tail versus positive-tail balance 60

- Family: `DISTRIBUTION_SHAPE`
- Concept: `TAIL_ASYMMETRY`
- Parameterization group: `FZ1_DST_005` / `SINGLE`
...
`mean(top10pct(r1))-abs(mean(bottom10pct(r1)))`
...
More favorable realized right-tail than left-tail behavior may distinguish upside optionality from crash exposure.
