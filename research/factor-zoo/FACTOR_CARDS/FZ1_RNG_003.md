# FZ1_RNG_003 — Negative Garman-Klass volatility 20

- Family: `RANGE_ATR_COMPRESSION`
- Concept: `LOW_GARMAN_KLASS_VOLATILITY`
- Parameterization group: `FZ1_RNG_003` / `SINGLE`
...
`-sqrt(252*mean(0.5*log(H/L)^2-(2*log(2)-1)*log(C/O)^2))`
...
OHLC structure may separate intraday variance from close-to-close noise.
