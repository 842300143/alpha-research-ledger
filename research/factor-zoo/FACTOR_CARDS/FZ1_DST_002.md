# FZ1_DST_002 — Negative excess kurtosis 60

- Family: `DISTRIBUTION_SHAPE`
- Concept: `LOW_TAIL_THICKNESS`
- Parameterization group: `FZ1_DST_002` / `SINGLE`
...
Lower realized tail thickness may identify more stable return distributions.
