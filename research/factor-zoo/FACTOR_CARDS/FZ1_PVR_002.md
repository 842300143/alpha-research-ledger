# FZ1_PVR_002 — Return-volume correlation 60

- Family: `PRICE_VOLUME_RELATION`
- Concept: `PRICE_VOLUME_CORRELATION`
- Parameterization group: `PG_PVR_CORRELATION` / `MEDIUM`
...
`corr(r1,delta(log1p(volume))) over 60`
...
Medium-horizon price-volume co-movement may reveal durable accumulation or distribution.
