# FZ1_MKT_004 — Residual reversal 20

- Family: `MARKET_BETA_RESIDUAL`
- Concept: `MARKET_ADJUSTED_REVERSAL`
- Parameterization group: `FZ1_MKT_004` / `SINGLE`
...
`-sum(OLS_residual(r1~market_r1) over 20)`
...
Stock-specific price pressure may reverse after removing common market movement.
