# FZ1_TRD_003 — Dual moving-average trend 20/60

- Family: `TREND`
- Concept: `DUAL_MOVING_AVERAGE`
- Parameterization group: `FZ1_TRD_003` / `SINGLE`
- Abstraction: `ATOMIC`
...
`mean(adj_close[t-19:t]) / mean(adj_close[t-59:t]) - 1`
...
A short average above a medium average indicates persistent trend state rather than one endpoint return.
