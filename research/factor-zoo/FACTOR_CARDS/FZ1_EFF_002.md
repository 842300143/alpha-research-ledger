# FZ1_EFF_002 — Kaufman efficiency ratio 60

- Family: `PRICE_EFFICIENCY_TREND_NOISE`
- Concept: `DIRECTIONAL_EFFICIENCY`
- Parameterization group: `PG_EFF_KAUFMAN` / `MEDIUM`
...
`abs(adj_close[t]-adj_close[t-60])/sum(abs(delta(adj_close)) over 60)`
...
A price path with less back-and-forth noise may represent more efficient information diffusion.
