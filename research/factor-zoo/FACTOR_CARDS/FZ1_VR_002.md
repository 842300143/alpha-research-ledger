# FZ1_VR_002 — Risk-adjusted return 20

- Family: `VOLATILITY_RETURN_RELATION`
- Concept: `RETURN_TO_RISK`
- Parameterization group: `FZ1_VR_002` / `SINGLE`
...
Return achieved with less realized risk may be more persistent than raw momentum.
