# FZ1_TOV_005 — Negative turnover variability 20

- Family: `TURNOVER_DYNAMICS`
- Concept: `TURNOVER_STABILITY`
- Parameterization group: `FZ1_TOV_005` / `SINGLE`
...
`-std(turnover,20)/(mean(turnover,20)+1e-12)`
...
Stable turnover may identify durable liquidity/attention rather than event bursts.
