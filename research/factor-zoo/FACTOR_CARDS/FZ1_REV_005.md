# FZ1_REV_005 — Three-day run-up reversal

- Family: `REVERSAL`
- Concept: `VERY_SHORT_RUNUP_EXHAUSTION`
- Parameterization group: `FZ1_REV_005` / `SINGLE`
- Abstraction: `ATOMIC`
...
`-(adj_close[t] / adj_close[t-3] - 1)`

Lookback/input horizon: 3 sessions.
...
Very short run-ups may exhaust temporary demand and mean-revert.
