...
Alpha Factory work commit `9bad5b9a5023e2d71f318a933a5d519ad4e8e0fc` resolves the seven CAQUAL01 data gaps as four non-entitlement reference-data events for `000029.SZ` and three elective rights offerings for `000049.SZ`, `000065.SZ`, and `000088.SZ`. All seven factor/preclose changes reconcile at the frozen tick/tolerance. CAQUAL01's 280 matches remain intact, so event-data coverage is 287/287 with zero unknown or contradictory rows.
